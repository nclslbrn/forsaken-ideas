...
import vertSrc from './glsl/design-a-rug.vert'
import fragSrc from './glsl/design-a-rug.frag'
import p5 from 'p5'
...
const sketch = (p5) => {
    ...
    sketch.capture = () => p5.saveCanvas(canvas, 'design-a-rug.jpg')

    sketch.shuffle = () => {
        const numSplit = 2 + Math.ceil(Math.random() * 10)
        ...
        traits.noiseSeed = Math.random() * 1000
        traits.noiseSize = 1 + Math.random() * 2.5
        traits.aspectRatio = p5.width / p5.height
        console.log(traits)
        p5.redraw()
    }
}
