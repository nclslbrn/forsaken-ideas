...
export default [
    ...
    // prettier-ignore
    (i, j) =>
        floor(sin(i * 0.3) * cos(j * 0.3) * 4) % 2,
    // prettier-ignore
    (i, j) =>
        (floor(i * cos(j * 0.2)) + j) % 5 < 2,
    // prettier-ignore
    (i, j) =>
        abs(sin(i * j * 0.1)) > 0.6,
    ...
    // prettier-ignore
    (i, j) =>
        (i ^ j) % floor(random() * 16 + 4) <
        floor(random() * 8 + 2),
    // prettier-ignore
    (i, j) =>
        sin(i * random() * 2) * cos(j * random() * 3)
        > random() - 0.5,
    // prettier-ignore
    (i, j) =>
        ((i + j) * random() * 10) % 7 < 3,
