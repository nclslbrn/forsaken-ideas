...
import vertSrc from './glsl/pure-black-and-white.vert'
import fragSrc from './glsl/pure-black-and-white.frag'
import p5 from 'p5'
...
const sketch = (p5) => {
    ...
    sketch.shuffle = () => {
        const numSplit = 2 + Math.ceil(Math.random() * 16)
        ...
        traits.noiseSeed = Math.random() * 999999
        traits.noiseSize = 0.1 + Math.random() * 2
        p5.redraw()
    }
}
