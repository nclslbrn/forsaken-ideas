...
import vertSrc from './glsl/subdivision.vert'
import fragSrc from './glsl/subdivision.frag'
import p5 from 'p5'
...
const sketch = (p5) => {
    ...
    sketch.capture = () => p5.saveCanvas(canvas, 'Subdivision.jpg')
    sketch.shuffle = () => {
        numSplit = 2 + Math.ceil(Math.random() * 30)
        grid = [[0.5, 0.5, 1, 1]]
